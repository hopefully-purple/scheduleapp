...
class SlideInTransitionLeft: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if isPresenting {
            ...
            toViewController.view.frame =  CGRect(x: regWidth, y: 0, width: finalWidth, height: finalHeight)
        }
